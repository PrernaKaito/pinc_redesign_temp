...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($formType === 'contactForm') {
        ...
        $inquiryType = filter_input(INPUT_POST, 'inquiryType', FILTER_SANITIZE_STRING);
        $textmessage = filter_input(INPUT_POST, 'textmessage', FILTER_SANITIZE_STRING);

        
        if (empty($name) || empty($email) || empty($mobile) || empty($city) || empty($inquiryType)  || empty($textmessage) ) {
...
$recaptchaSecret = '6LcXmoUqAAAAACdLChI0GPSFDJDoN_mRBkKhRFcp';  // Replace with your secret key
    ...
    echo 'Form submitted successfully!';
        ...
        try {
            ...
            $mailer->Body = "
                ...
                <p><strong>Select:</strong> $inquiryType </p>
...
<body style='font-family: Open Sans;'>
    <table align='center' border='0' cellpadding='0' cellspacing='0' style='width:100%;margin:0 auto;background-color:#ffffff;'>
                ...
                <td align='center' style='width:680px;' valign='top'>
                    <table align='center' style='border:1px solid #2EBBA8; background-color: #ffffff;' cellpadding='0' cellspacing='0'>
                        <tbody>
                            <tr>
                                <td align='center'>
                                    <a href='https://www.pincinsurance.com/' target='_blank'>
                                        <img src='https://www.pincinsurance.com/img/Thank-you-banner.png' width='100%' /></a>
                                </td>
                            </tr>
                            ...
                            <!-- Social Media Icons -->
                            <tr style='background-color: #f7f7f7;   cursor: pointer; '>
                                <td style='padding:50px 23px 40px;text-align: center;'>
                                    <div style='margin-bottom: 10px;'>Follow us on</div>
                                    <a href='https://www.facebook.com/PINCInsurance/'  style='text-decoration: none;' target='_blank'>
                                        <img src= 'https://www.pincinsurance.com/img/SM-02.png' style='font-size:30px; margin-right:15px; color:#e1056d;'></i>
                                    </a>
                                    <a href='https://x.com/PINCInsurance'  style='text-decoration: none;' target='_blank'>
                                     <img src= 'https://www.pincinsurance.com/img/SM-03.png' style='font-size:30px; margin-right:15px; color:#e1056d;'></i>
                                    </a>
                                    <a href='https://www.instagram.com/pinc_insurance/?hl=en'  style='text-decoration: none;' target='_blank'>
                                        <img src= 'https://www.pincinsurance.com/img/SM-04.png' style='font-size:30px; margin-right:15px; color:#e1056d;'></i>
                                    </a>
                                    <a href='https://www.linkedin.com/company/pincinsurance/'  style='text-decoration: none;' target='_blank'>
                                        <img src= 'https://www.pincinsurance.com/img/SM-01.png' style='font-size:30px; color:#e1056d;'></i>
                                    </a>
                                </td>
                            </tr>
        ...
        $inquiryType2 = filter_input(INPUT_POST, 'inquiryType2', FILTER_SANITIZE_STRING);
        $company = filter_input(INPUT_POST, 'company', FILTER_SANITIZE_STRING);
        $message = filter_input(INPUT_POST, 'message', FILTER_SANITIZE_STRING);

        if (empty($fullname) || empty($email) || empty($contactNumber) || empty($company) || empty($message) || empty($inquiryType2)) {
            http_response_code(400);
            echo 'Please fill in all required fields.';
            exit;
        }
        ...
        try {
            ...
            $mailer->Body = "
                ...
                <p><strong>Contact Email:</strong> $email</p>
                  <p><strong>Select:</strong> $inquiryType2</p>
